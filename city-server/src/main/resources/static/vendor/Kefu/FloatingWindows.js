...
$(function () {
    ...
    new Dialog({ Info: "返利平台", Content: '<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=847055719&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:847055719:53" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>', Width: 120, Height: 200, Left: 800, Top: 620  });

    //var creat=function() {
    //    new Dialog({ Info: title = "烈火学院-标题" + i, Left: 300 + left, Top: 300 + left, Content: '欢迎访问烈火学院 www.veryhuo.com 内容' + i, Zindex: (++Dialog.Zindex) });
    //    i++; left += 10;
    //}
