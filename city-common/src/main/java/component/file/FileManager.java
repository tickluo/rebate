...
public class FileManager {
     ...
     * @return 文件对象
     */
    public FileModel save(FileModel ufi) {
        FileModel[] fs = saves(ufi);
        return fs[0];
    }
     ...
     * @return 文件对象
     */
    public FileModel[] saves(FileModel... ufis) {

        List<FileModel> arr = new ArrayList<>();
        for (FileModel ufi : ufis) {
        ...
        return arr.toArray(new FileModel[0]);
    }
